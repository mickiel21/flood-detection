    ...
    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight"><a
                ...
                <PrimaryLink :href="route('sensors.index', { filter: 'only' })" class="max-w-xl ml-2">View Trashed
                </PrimaryLink>
            ...
            <table class="w-full whitespace-no-wrap">
                ...
                <tbody>
                    <tr v-for="entry in props.sensors.data" :key="entry.id" class="text-gray-700">
                        ...
                        <td class="border-b border-gray-200 bg-white px-5 py-5 text-sm">
                            <PrimaryLink v-if="entry.deleted_at == null" :href="route('sensors.edit', { 'id': entry.id })"
